class VisitToDentist extends Visit{
    ...
    super(id, visitor, doctor, priority, dateTime, goal, description, lastVisit, status);
    }

    render() {
        super.createCard();
        this.dateTimeStr = super.dateTimeToString(this.dateTime);
        this.dateStr = super.dateToString(this.lastVisit);
        ...
        this.card.innerHTML = `
            ...
            <div class="card-body">
                ...
                <div class="card-body-hide hide">
                    ...
                    <p class="desc" data-last="${this.lastVisit}">${this.dateStr}</p>
                </div>
            </div>`;
